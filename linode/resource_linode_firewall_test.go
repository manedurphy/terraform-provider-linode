		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testFirewallResName, "inbound.0.ports.0", "80"),
					resource.TestCheckResourceAttr(testFirewallResName, "inbound.0.addresses.0", "0.0.0.0/0"),
					...
					resource.TestCheckResourceAttr(testFirewallResName, "outbound.0.ports.0", "80"),
					resource.TestCheckResourceAttr(testFirewallResName, "outbound.0.addresses.0", "0.0.0.0/0"),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testFirewallResName, "inbound.1.ports.0", "443"),
					resource.TestCheckResourceAttr(testFirewallResName, "inbound.1.addresses.0", "0.0.0.0/0"),
					resource.TestCheckResourceAttr(testFirewallResName, "inbound.2.protocol", "TCP"),
					resource.TestCheckResourceAttr(testFirewallResName, "inbound.2.ports.0", "22"),
					resource.TestCheckResourceAttr(testFirewallResName, "inbound.2.addresses.0", "0.0.0.0/0"),
